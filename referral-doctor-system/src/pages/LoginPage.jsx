        ...
        <div className="hidden lg:flex flex-1 flex-col justify-center text-white">
          <div className="mb-8">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Professional hospital management software for seamless patient care and referral tracking.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              ...
              <div>
                <h3 className="font-semibold">Complete Patient Management</h3>
                <p className="text-blue-100 text-sm">Track all patient visits and history</p>
              </div>
            </div>
            <div className="flex gap-3">
              <span className="text-2xl">✓</span>
              <div>
                <h3 className="font-semibold">Doctor Network Management</h3>
                <p className="text-blue-100 text-sm">Manage referrals from multiple doctors</p>
              </div>
            </div>
            <div className="flex gap-3">
              <span className="text-2xl">✓</span>
              <div>
                <h3 className="font-semibold">Integrated Billing System</h3>
                <p className="text-blue-100 text-sm">Generate professional invoices instantly</p>
              </div>
            </div>
            <div className="flex gap-3">
              <span className="text-2xl">✓</span>
